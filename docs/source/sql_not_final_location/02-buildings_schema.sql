...
COMMENT ON SCHEMA buildings IS 'The schema holds builing information. this is a dummy comment field, '
'much more could be said in this comment field, which is multiline '
'Lets home we can be more verbose ';
