...
def get_column_comments(column_str, file_content):
    ...
    if column_comment_search is not None:
        ...
        print "1 column_comment_result_clean_lower is: ", column_comment_result_clean_lower
        if "foreign key to the" in column_comment_result_clean_lower:
            ...
            print "front comment:" + "'" + front_comment + "'"
            ...
            #print "foreign_link is: ", foreign_link
            #if foreign_search.group(1) and foreign_search.group(4):
            column_comment_result_strip = front_comment + foreign_key_comment + foreign_link + " table" + end_comment
            #print "A"
            #if (foreign_search.group(1) is None) and (foreign_search.group(4) is None):
                #column_comment_result_strip = foreign_key_comment + foreign_link + "table"
                #print "B"
            #if foreign_search.group(1) and (foreign_search.group(4) is None):
                #column_comment_result_strip = front_comment + foreign_key_comment + foreign_link + "table."
                #print "C"
            #if foreign_search.group(1) is None and foreign_search.group(4):
                #column_comment_result_strip = foreign_key_comment + foreign_link + "table." + end_comment
                #print "D"


    if column_comment_search is None:
        column_comment_result_strip = " "
    print "2 column_comment_result_strip is: ", column_comment_result_strip
    print "    "
    print "    "
